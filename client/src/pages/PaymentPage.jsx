    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-sm mx-auto p-4 space-y-4">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-5 text-center">
          <div className="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-3">Or send via Bluetooth / Share</div>
          <p className="text-xs text-gray-500 mb-3">Share the encrypted packet directly with the relay person nearby</p>
          <button
